...
public class FantasmaEstatico {
    ...
    public FantasmaEstatico(Image _image, double x, double y, double velX, double velY, int ANCHO, int ALTURA, double width, double height) {
        this.image=_image;
        this.posX = x;
        this.posY = y;
    ...
    public FantasmaEstatico() {}

    public static ArrayList<FantasmaEstatico> defaultFantasma() {
        ...
        ArrayList<FantasmaEstatico> fantasmas = new ArrayList<>();
